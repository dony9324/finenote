...
<section class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<a href="index.php?view=teacher&o=new" class="btn btn-default"><i class='glyphicon glyphicon-user'></i> Nuevo</a>
			<br><br>
			<?php
			$users = teacherData::getAll();
			if(count($users)>0){
				?>
		...
		<section class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<br>
					<form class="form-horizontal" method="post" id="addproduct" action="index.php?action=teacher&o=add" role="form">
