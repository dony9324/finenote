...
if((isset($_SESSION["kind"]) && $_SESSION["kind"] != 1 && $_GET["o"] != "onpass")){Core::redir("./");}
...
<section class="container">
  ...
  <?php elseif(isset($_GET["o"]) && $_GET["o"]=="onpass"):?>
    <div class="container">
      <?php $user = UserData::getById($_GET["id"]);?>
      <div class="row">
        <div class="col-md-12">
          ...
          <h1>Editar Usuario</h1>
          <br>
          <p class="help-block">Antes de usar el sistema debes cambiar tu contraseña y opcionalmente tu nombre de usuario.</p>
          <form class="form-horizontal" method="post" id="addproduct" action="index.php?action=users&o=onpass" role="form">
            <div class="form-group">
              <label for="inputEmail1" class="col-lg-2 control-label">Nombre de usuario*</label>
              <div class="col-md-6">
                <input type="text" name="username" value="<?php echo $user->username;?>" class="form-control" required id="username" placeholder="Nombre de usuario">
            ...
            <div class="form-group">
              <label for="inputEmail1" class="col-lg-2 control-label">Contrase&ntilde;a</label>
              <div class="col-md-6">
                <input type="password" required name="password" class="form-control"  placeholder="Contrase&ntilde;a">
              </div>
            </div>
            <div class="form-group">
              <label for="inputEmail1" class="col-lg-2 control-label">Verificar contraseña.</label>
              <div class="col-md-6">
                <input type="password" required  name="password2" class="form-control" placeholder="Contrase&ntilde;a">
              </div>
            </div>
